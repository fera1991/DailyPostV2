...
const PostCard = ({ post, listSaved, userLogin, archivePost }) => {
  ...
  const searchAndActivate = async () => {
    ...
    if (result) {
      ...
      const bollLiked = result.some(
        (data) => data.user.code === userLogin.code
      );
      if (bollLiked) {
        setIsLiked(true);
      }
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-3">
            <div className="flex items-center space-x-2">
              <div className="-space-y-1">
                ...
                <span className="inline-block text-xs leading-none text-gray-500">
                  {post.title}
                </span>
              </div>
            </div>
            ...
            {showOptions && (
              <div
                className="absolute bg-white rounded shadow-md mt-7"
          ...
          <img
            src={post.image}
            alt=""
            className="bg-coolGray-500 w-full object-cover object-center"
            style={{
              width: "100%",
              height: "60%",
          ...
          <div className="p-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
                    stroke={`${isLiked ? "red-700" : "currentColor"}`}
                    className={`w-6 h-6 ${
                      isLiked ? "fill-red-700" : "fill-none"
                    }`}
                  >
                    <path
                      strokeLinecap="round"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
                  stroke={`${isSaved ? "yellow-400" : "currentColor"}`}
                  className={`w-6 h-6 ${
            ...
            <span className="mt-2 font-bold">{post.user.username}: </span>
            {post.description}
          </div>
        </div>
      </div>
  ...
  const SecondaryCard = () => {
    ...
    return (
      <div className=" text-black post-card">
        ...
        >
          <button
            onClick={() => setShowPrimaryCard(true)}
            className="absolute top-5 right-[-20px] mt-2 mr-2 text-xl font-bold text-black hover:text-red-500"
            title="close post"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className="flex overflow-hidden rounded-lg bg-gray-100 shadow-lg "
