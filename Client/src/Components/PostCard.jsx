      ...
      <div className="min-h-48 flex items-center justify-center p-7 px-6">
        <div className="bg-gray-100 text-black rounded-md shadow-md sm:w-96">
          <div className="flex items-center justify-between p-3">
            ...
            {showOptions && (
              <div className="absolute bg-white rounded shadow-md mt-7" style={{ marginLeft: '240px' }}>
                <ul>
  ...
  const SecondaryCard = () => {
    ...
    <div className=" text-black post-card">
      <div className="container relative mx-auto min-h-48 flex items-center justify-center p-10 px-6">
        ...
        <div className="flex overflow-hidden rounded-lg bg-gray-100 shadow-lg " style={{ maxWidth: '800px' }}>
          ...
          <div className="flex w-full flex-col md:w-1/2">
            <div className="flex items-center justify-between border-b border-black p-2">
              ...
              {showOptions && (
                <div className="absolute bg-white rounded shadow-md mt-7" style={{ marginLeft: '270px' }}>
                  <ul>
                    <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Editar</li>
                    <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Eliminar</li>
                  </ul>
